...
package com.adobe.assurance_tvos_testapp.ui.navigation
...
import com.adobe.assurance_tvos_testapp.ui.views.AssuranceScreen
import com.adobe.assurance_tvos_testapp.ui.views.CoreScreen
...
internal fun AppNavigation(
    ...
    NavHost(navHostController, NavRoutes.AssuranceRoute.route) {
        ...
        composable(NavRoutes.MessagingRoute.route) {
//            MessagingScreen()
        }
    }
}