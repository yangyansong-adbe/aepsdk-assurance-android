...
import com.adobe.assurance_tvos_testapp.ui.theme.Purple40
import com.adobe.assurance_tvos_testapp.ui.theme.Purple80

@Composable
internal fun DrawerItem(item: NavRoutes, selected: Boolean, onItemClick: (NavRoutes) -> Unit) {
    val background = if (selected) Purple40 else Purple80
    Row(
