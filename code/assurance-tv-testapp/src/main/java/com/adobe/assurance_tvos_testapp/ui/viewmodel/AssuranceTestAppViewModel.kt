...
package com.adobe.assurance_tvos_testapp.ui.viewmodel
...
internal class AssuranceTestAppViewModel (savedStateHandle: SavedStateHandle) : ViewModel() {
    ...
    var triggerWord by savedStateHandle.saveable(stateSaver = TextFieldValue.Saver) {
        mutableStateOf(TextFieldValue(""))
    }
    fun updateTriggerWord(updateTriggerWord: TextFieldValue) {
        triggerWord = updateTriggerWord
    }
